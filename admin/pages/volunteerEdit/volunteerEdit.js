...
Page({
  ...
  detail: function (e) {
    wx.navigateTo({
      url: '../volunteerDetail/volunteerDetail?id=' + this.data.id,
    })
  },
  ...
  confirm: function (e) {
    ...
    if (this.data.title == null || this.data.address == null || this.data.year == null || this.data.month == null || this.data.day == null || this.data.hour == null || this.data.minute == null || this.data.second == null || this.data.introduce == null) {
      wx.showToast({
        title: '输入不能为空！',
        image: '../../images/icons/warning.png',
        duration: 2500
